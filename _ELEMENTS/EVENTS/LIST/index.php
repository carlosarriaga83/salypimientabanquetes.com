								...
								$htmlOutput .= <<<H
												<td class="text-center">
													<div class="d-flex align-items-center gap-10 justify-content-center">
														...
														<button type="button" class=" bg-hover-lilac-200 text-lilac-600 btn-lilac-100 fw-medium w-40-px h-40-px d-flex justify-content-center align-items-center rounded-circle" onclick="GENERA_LISTA({$row['ID']});">
															<iconify-icon icon="mdi:file-download-outline" class="icon text-xl"></iconify-icon>
														</button>
