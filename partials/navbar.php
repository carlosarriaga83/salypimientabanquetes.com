...
<?php
	...
	$q = sprintf("SELECT * FROM Users WHERE id = '%s'   ", $_SESSION['USER']['ID']);  // echo $q . "\n";
	$R1 = SQL_2_OBJ_V2($q);
	//print_r($R1);die;
    ...
    // NOMBRE DEL ROL 
        ...
        $USER_ROL_NAME = $ROL_ID_NAME[$USER_ROLE_ID];
		
	// MEMBRESIA


		$SUBSCRIPTION_STATUS = $_SESSION['USER']['PERTENENCIAS']['SUBSCRIPTIONS'][0]['subscription_status'];

			
		if ( $SUBSCRIPTION_STATUS == 'active' ) {
			$MEMBERSHIP_BADGE = '<span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-primary-400 border border-white"><iconify-icon icon="solar:crown-bold-duotone" class="icon"></iconify-icon></span>';
		}
...
<div class="navbar-header">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-auto" id="TOP_ALERT_DIV">
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        ...
                        <div class="dropdown">
                            <button class="d-flex justify-content-center align-items-center rounded-circle" type="button" data-bs-toggle="dropdown">
                                <img src="<?php echo $USER['AVATAR_PIC']; ?>" alt="image" class="w-40-px h-40-px object-fit-cover rounded-circle">
								<?php echo $MEMBERSHIP_BADGE; ?>
                            </button>
                            <div class="dropdown-menu to-top dropdown-menu-sm">
                                <div class="py-12 px-16 radius-8 bg-primary-50 mb-16 d-flex align-items-center justify-content-between gap-2">
                                    <div>
                                        <h6 class="text-lg text-primary-light fw-semibold mb-2"><?php echo "{$USER['ID']} - {$USER['NAME']}"; ?></h6>
                                        <span class="text-secondary-light fw-medium text-sm"><?php echo "{$USER['EMAIL']} - {$USER_ROL_NAME}"; ?></span>
                                ...
                                <ul class="to-top-list">
                                    <li>
                                        <a class="dropdown-item text-black px-0 py-8 hover-bg-transparent hover-text-primary d-flex align-items-center gap-3" href="view-profile.php<?php echo "?id={$USER['ID']}"; ?>">
